...
const addEventForm = document.querySelectorAll('.managerForm');
const cancelEventForm = document.querySelectorAll('.managerForm');

addEventForm.addEventListener('click', async (e) => {
    e.preventDefault();
...
cancelEventForm.addEventListener('click', async (e) => {
    e.preventDefault();
